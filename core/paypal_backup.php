<?php class Paypal {
    //to use for future websites you must adjust the mode, returnURL, and cancelURL below...
...
function SetExpressCheckout($returnURL, $cancelURL, $orderTotal, $costOfItems, $costOfShipping, $orderID, $itemArray, $currency = 'USD', $giftWrapAmount = 3.00) {
    //Our request parameters
    ...
    $orderParams['GIFTWRAPAMOUNT'] = $giftWrapAmount;
...
function DoExpressCheckoutPayment($orderTotal, $costOfItems, $costOfShipping, $orderID, $currency = 'USD', &$checkoutDetails = array()) {
